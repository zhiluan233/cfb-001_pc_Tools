...
#include "stdafx.h"
#include "cfbeventeditorwidget.h"
#include "ui_cfbeventeditorwidget.h"
#include "configs.h"
#include <QMessageBox>
#include <QPainter>
#include <QResource>
...
bool CreateEventEditor(ICFBEventEditor** ppEventEditor)
{
    CFBEventEditorWidget* pProxy = new CFBEventEditorWidget();
    if (pProxy)
    {
...
CFBEventEditorWidget::CFBEventEditorWidget(QWidget *parent) :
    QWidget(parent)
    , ui(new Ui::CFBEventEditorWidget)
    , m_pNotify(NULL)
    //, m_pFlowControl(NULL)
{
    ui->setupUi(this);
    ...
    QString rccPath = CConfigs::getAppSubDirPath(SUBDIR_RES) + QDir::separator() + "cfbeventeditor.rcc";
    QResource::registerResource(rccPath);
    setDefaultStyle();

    initCtrls();

    connect(ui->pushButton_addlisten1, &QPushButton::clicked, this, &CFBEventEditorWidget::onAddEventBtnClicked);
    connect(ui->pushButton_addlisten2, &QPushButton::clicked, this, &CFBEventEditorWidget::onAddEventBtnClicked);
    connect(ui->tabWidget_eventeditor, &QTabWidget::tabBarClicked, this, &CFBEventEditorWidget::onTabBarClicked);

#if 0
    connect(ui->toolButton_eventeditor1, &QToolButton::clicked, this, &CFBEventEditorWidget::onEventClicked);
    connect(ui->toolButton_eventeditor2, &QToolButton::clicked, this, &CFBEventEditorWidget::onEventClicked);
#endif
}

CFBEventEditorWidget::~CFBEventEditorWidget()
{
    clearListenEvents();
    delete ui;
}
...
bool CFBEventEditorWidget::Connect(QWidget* pWnd, ICFBEventEditorNotify *pNotify)
{
    m_pNotify = pNotify;
...
void CFBEventEditorWidget::ReleaseConnection()
{

}


QWidget* CFBEventEditorWidget::GetWidget()
{
    return this;
}


void CFBEventEditorWidget::GetData(char** ppData, int& nLen)
{
...
void CFBEventEditorWidget::SetData(char* pData, int nLen)
{
    clearListenEvents();
...
void CFBEventEditorWidget::initCtrls()
{
...
void CFBEventEditorWidget::onAddEventBtnClicked()
{
...
void CFBEventEditorWidget::clearListenEvents()
{
...
bool CFBEventEditorWidget::existEvent(emListenEventType eEventType)
{
    return findEventData(eEventType) != NULL;
}


LISTENEVENTDATA* CFBEventEditorWidget::findEventData(emListenEventType eEventType)
{
...
void CFBEventEditorWidget::onTabBarClicked(int nIndex)
{
...
void CFBEventEditorWidget::setDefaultStyle()
{
    QFile styleSheet(":/res/qss/cfbeventeditor.qss");
...
void CFBEventEditorWidget::paintEvent(QPaintEvent* pEvent)
{
    QStyleOption opt;
    opt.init(this);
    QPainter p(this);
...
void CFBEventEditorWidget::onEventClicked()
{
...
////设置流程图
//void CFBEventEditorWidget::setFlowControl(ICFBFlowControl* pFlowControl)
//{
