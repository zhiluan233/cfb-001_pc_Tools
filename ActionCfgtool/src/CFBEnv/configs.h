...
enum emTemplateDir
{
    CFB_DEFAULT_FLOW_TEMPLATE = 0, 
    CFB_DEFAULT_ACTION_TEMPLATE,
    CFB_CUSTOM_FLOW_TEMPLATE,
...
class CFBENV_EXPORT CConfigs : public utils::SingletonT<CConfigs>
{
public:
    explicit CConfigs();
    ~CConfigs();
