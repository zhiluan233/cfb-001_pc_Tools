#ifndef CFBWIDGETCONST_H
#define CFBWIDGETCONST_H

namespace CFBUiBaseConstants
{
    ...
    const char* const PROPERTY_PAGE_REAL_NUMBER = "PropertyPageRealNumber";//页码按钮对应的真实页码值属性
        ...
        // 颜色值
        const QString CFB_COLOR_GREY = "#d3d3d3";
        const QString CFB_COLOR_WHITE = "#ffffff";
        const QString CFB_COLOR_DARK_RED = "#ca0813";
        const QString CFB_COLOR_DARK_GREY = "#858585";
