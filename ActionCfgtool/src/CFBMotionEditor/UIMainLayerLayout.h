...
class MOTIONEDITOR_EXPORT CUIMainLayerLayout : public QWidget, public ILayerManager, public IUILayerManager_Event//20160519万向峰合并代码时注释掉
{
    Q_OBJECT
...
//    virtual void LayerManager_DeleteLayer(int nLayerID);
    virtual void LayerManager_Set3DRobotViewInterface(ICFBRobot3DView* pRobotView);
...
//    virtual void LayerManager_LayerPlaying(int layerType, ILayerOptionHandler* optionHandle);
    ...
    virtual void LayerManager_SetSocketSession(CICFBSocketSession* pSession);
