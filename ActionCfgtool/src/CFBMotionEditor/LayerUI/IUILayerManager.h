...
public:
    ...
    virtual void Set3DRobotViewInterface(ICFBRobot3DView* pRobotView) = 0;
    virtual ICFBRobot3DView* Get3DRobotViewInterface() = 0;
    ...
    virtual void IUILayerManager_SetSocketSession(CICFBSocketSession* pSession) = 0;
