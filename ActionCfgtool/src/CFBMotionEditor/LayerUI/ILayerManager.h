...
//    virtual void LayerManager_DeleteLayer(int nLayerID) = 0;
    ...
    virtual void LayerManager_Set3DRobotViewInterface(ICFBRobot3DView* pRobotView) = 0;
...
//    virtual void LayerManager_LayerPlaying(int layerType, ILayerOptionHandler* optionHandle) = 0;
    ...
    virtual void LayerManager_SetSocketSession(CICFBSocketSession* pSession) = 0;
