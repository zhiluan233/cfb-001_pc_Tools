...
//    virtual void IGroupDataManagerPlay_SetRobot3DView(ICFBRobot3DView* pSession);
    virtual void IGroupDataManagerPlay_SetLayerManager(IUILayerManager* pLayerManager);

    
    virtual void IGroupDataManagerPlay_SetSocketSession(CICFBSocketSession* pSession);
