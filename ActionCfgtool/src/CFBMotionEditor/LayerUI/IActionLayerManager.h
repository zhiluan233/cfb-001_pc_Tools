...
//    virtual void AdjustData() =0;
    virtual void ActionLayerManager_Set3DRobotViewInterface(ICFBRobot3DView* pRobotView) = 0;
    virtual void ActionLayerManager_SetSocketSession(CICFBSocketSession* pSession) = 0;
