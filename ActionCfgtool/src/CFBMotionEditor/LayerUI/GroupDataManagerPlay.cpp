...
//void CGroupDataManagerPlay::IGroupDataManagerPlay_SetRobot3DView(ICFBRobot3DView* pSession)
//{
...
void CGroupDataManagerPlay::IGroupDataManagerPlay_SetSocketSession(CICFBSocketSession *pSession)
{
