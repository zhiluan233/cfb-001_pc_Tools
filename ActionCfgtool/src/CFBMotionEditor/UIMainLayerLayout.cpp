...
//{
////    CCFBMotionEditorLayout* pDlg = (CCFBMotionEditorLayout*)parentWidget();
...
void CUIMainLayerLayout::LayerManager_Set3DRobotViewInterface(ICFBRobot3DView* pRobotView)
{
    if (m_pUILayerManager)
    {
...
void CUIMainLayerLayout::LayerManager_SetSocketSession(CICFBSocketSession* pSession)
{
