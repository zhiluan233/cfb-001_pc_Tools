...
bool CFBSOCKETSESSIONSHARED_EXPORT CreateSendFileSocket(ISendFileSession** ppSession);
...
bool CFBSOCKETSESSIONSHARED_EXPORT CreateUploadFileSocket(IUploadFileSession** ppSession);
