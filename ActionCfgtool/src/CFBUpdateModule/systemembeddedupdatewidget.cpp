...
#include "cfbupdatemoduleconst.h"
    ...
    m_nUpdateProgressTimerID(0)
{
    ...
    CFBWidget::setDefaultStyle(this, UPDATE_MODULE_DEFAULT_QSS);
...
void SystemEmbeddedUpdateWidget::slotOnRobotUDiskShowUp(bool bShowup)
{
    ...
    QString strBsdPath;
    QString strUdiskName = CCFBUdiskManager::getUdiskName(strBsdPath);
    QString strUdiskRootPath = CCFBUdiskManager::getUdiskRootPath();
...
{
    QString sUpdateUrl = CFBUpdateAdministrator::getInstance()->getUpdateBasicUrl();
//#ifndef QT_NO_DEBUG
////    m_eRobotType = eCheckUpdateTypeNewRobot1SV2;  //更新版1S机器人端软件
//    sUpdateUrl =  "http://10.10.1.14:8080/cfb/version/verify/";
// #endif
